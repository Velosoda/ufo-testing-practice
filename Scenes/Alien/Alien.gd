...
func shoot():
	...
	bullet_instance.rotation_degrees = $Pointer.rotation_degrees
	bullet_instance.apply_impulse(Vector2(), Vector2(bullet_instance.SPEED,0).rotated($Pointer.rotation))
